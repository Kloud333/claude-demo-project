#!/usr/bin/env bash
#
# ЩО ЦЕ: виконуваний скрипт всередині skill-папки (scripts/). Claude
# ЗАПУСКАЄ його (bash scripts/check.sh), а не завантажує вміст файлу
# в контекст — тільки ВИВІД скрипту споживає токени. Так skill може
# "нести" з собою власний тулінг без витрат context window.
#
